...
template<class... Ts, class C = char, class Tr = char_traits<C>> [[nodiscard]] constexpr auto variadic_reader(basic_istream<C, Tr>& is) { return [&is](Ts&... ts) -> basic_istream<C, Tr>& { return (is >> ... >> ts); }; }
