...
const i64 mod = (119 << 23) + 1, root = 62; // = 998244353
...
void ntt(vi64& a)
{
	i64 n = size(a), L = 31 - __builtin_clz(n);
	static vi64 rt(2, 1);
	for (static i64 k = 2, s = 2; k < n; k *= 2, s++)
	{
		rt.resize(n);
	...
	for (i64 k = 1; k < n; k *= 2)
		for (i64 i = 0; i < n; i += 2 * k) rep(j, 0, k)
		{
