...
struct entry
{
	X a, e, b, g, d, p, l, h, j, n, i, m, k, o;
	Z q, r, w, v, t, s, u;
};

void go()
{
	cout << offsetof(entry, a) << endl;
	cout << offsetof(entry, e) << endl;
	cout << offsetof(entry, b) << endl;
	cout << offsetof(entry, g) << endl;
	cout << offsetof(entry, d) << endl;
	cout << offsetof(entry, p) << endl;
	cout << offsetof(entry, l) << endl;
	cout << offsetof(entry, h) << endl;
	cout << offsetof(entry, j) << endl;
	cout << offsetof(entry, n) << endl;
	cout << offsetof(entry, i) << endl;
	cout << offsetof(entry, m) << endl;
	cout << offsetof(entry, k) << endl;
	cout << offsetof(entry, o) << endl;
	cout << endl;
	cout << offsetof(entry, q) << endl;
	cout << offsetof(entry, r) << endl;
	cout << offsetof(entry, w) << endl;
	cout << offsetof(entry, v) << endl;
	cout << offsetof(entry, t) << endl;
	cout << offsetof(entry, s) << endl;
	cout << offsetof(entry, u) << endl;

	cout << sizeof(array<entry1, 7>);
}*/
