...
{
	i64 o, i;
	friend bool operator<(Weight l, Weight r) { return l.o < r.o || l.o == r.o && l.i < r.i; }
	i64 t() { return o + i; }
};
...
void go()
{
	...
	rep(i, 0, p)
	{
		...
		fill(ALL(D), pi64{ MAX<i64>, MAX<i64> });
