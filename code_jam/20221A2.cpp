...
constexpr i64 N = 100;
constexpr i64 MAXA = 1e9;
constexpr i64 MAXS = 2 * N * MAXA;
vi64 P2{};
vi64 NP2{};
i64 P2S = 0;
i64 NP2S = 0;
...
void pre()
{
	for (i64 i = 1; i <= MAXA; i *= 2)
	{
		P2.push_back(i);
		P2S += i;
	}
	reverse(ALL(P2));
	for (i64 i = 0; i + P2.size() < N; i++)
	{
		NP2.push_back(1025 + i);
		NP2S += 1025 + i;
	}
}
